package org.edtp.theexchange.neoforge.config;
...
public class NeoForgeConfigLoader implements ExchangeAPI.ConfigLoader {
    ...
    public NeoForgeConfigLoader() {
        this.configDir = FMLPaths.CONFIGDIR.get().resolve(CONFIG_DIR_NAME);
    }
